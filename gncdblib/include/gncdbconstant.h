 ...
 * @LastEditTime: 2025-02-26 15:52:07
 */
...
#define LOG_PRINT(logtype, dbLogStr)                                     \
    (DBLoggerPrint(logtype, dbLogStr, __FILE__, __FUNCTION__, __LINE__))   
...
// static double tuple_cost = 1;
// static double cpu_operator_cost =  0.25;
static double MEM_PAGE_COST = 50;
static double RANDOM_PAGE_COST = 400;
#endif  
