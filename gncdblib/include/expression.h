...
typedef enum { CJET_AND, CJET_OR } ConjunctionExprType;
typedef enum { ADD, SUB, MUL, DIV, NEGATIVE } ArithmeticExprType;
...
int fieldExprCheckField(HashMap* tableMap, varArrayList* tables, GNCDB* db, FieldExpr* fieldExpr, BtreeTable* defaultTable, HashMap* tableAliasMap);
bool exprCheckCanPushDown(Expression* expr, HashMap* tableMap);
int exprCheckField(HashMap* tableMap, varArrayList* tables, GNCDB* db, Expression* expr, BtreeTable* defaultTable, HashMap* tableAliasMap);
...
int exprTraverseCheckPrepare(Expression* expr, CheckFunc checkFunc, varArrayList* fields, int additionalParamsCount, ...);
int exprTraverseCheck(Expression* expr, CheckFunc checkFunc, varArrayList* fields, int additionalParamsCount, va_list ap);
...
ConjunctionExpr* ConjunctionExprCreate(ConjunctionExprType conjunctionType, varArrayList* children, char* name, char* alias);
ArithmeticExpr* ArithmeticExprCreate(ArithmeticExprType arithmeticType, Expression* left, Expression* right, char* name, char* alias);
